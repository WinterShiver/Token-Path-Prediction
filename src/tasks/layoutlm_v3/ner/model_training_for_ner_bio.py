...
from src.dataset.feature_processor.layoutlm_v3.ner_bio_processor import LayoutLMv3ForBIO2NerProcessor
...
class LayoutLMv3NERBIOModelModule(pl.LightningModule):
    def __init__(self,
...
class LightningRunner:
    ...
    def run(self):
        ...
        # 加载分词器
        tokenizer = LayoutLMv3TokenizerFast.from_pretrained(pretrained_model_name_or_path=self.args.pretrained_model_path)
        ...
        data_processor_train = LayoutLMv3ForBIO2NerProcessor(tokenizer=tokenizer,
        ...
        data_processor = LayoutLMv3ForBIO2NerProcessor(tokenizer=tokenizer,
                                                       ner_labels=ner_labels,
                                                       box_level=self.args.box_level,
                                                       max_text_length=self.args.max_length,
                                                       norm_bbox_height=self.args.norm_bbox_height,
        ...
        model = LayoutLMv3NERBIOModelModule(
            ner_labels=ner_labels,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', default='../../../data/funsd', type=str)
    ...
    parser.add_argument('--pretrained_model_path', default='../../../data/pretrained_models/layoutlmv3-base-chinese',
                        type=str)
