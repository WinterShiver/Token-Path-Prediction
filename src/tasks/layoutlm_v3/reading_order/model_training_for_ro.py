...
from src.model.layoutlm_v3.modeling_layoutlmv3 import LayoutLMv3ForReadingOrder
...
class CodeDocLayoutROTLModelModule(pl.LightningModule):
    def __init__(self,
        ...
        # self.config.enable_position_1d = False # 用来屏蔽1d位置编码
        ...
        self.model = LayoutLMv3ForReadingOrder.from_pretrained(config=self.config,
